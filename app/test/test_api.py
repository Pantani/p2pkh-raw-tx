...
class TestUserModel(BaseTestCase):
    ...
    async def test_create_transaction_invalid_request(self, client: TestClient) -> None:
        response = await client.post('/payment_transactions', data='invalid json')
        assert response.status == 400

    async def test_create_transaction_with_negative_amounts(self, client: TestClient) -> None:
    ...
    async def test_create_transaction_with_negative_fee(self, client: TestClient) -> None:
        response = await client.post('/payment_transactions', json={
            "source_address": "mfetsqmVYU1m3w1MNXaDg4cvGYwXJB47Kx",
            "outputs": {
                "mhnnkpnCfBkxN5KpfMArye2F376nATVJDW": "-0.0001",
    ...
    async def test_create_transaction_with_invalid_amount_precision_input(self, client: TestClient) -> None:
        response = await client.post('/payment_transactions', json={
            "source_address": "mfetsqmVYU1m3w1MNXaDg4cvGYwXJB47Kx",
            "outputs": {
    ...
    async def test_create_transaction_with_empty_outputs(self, client: TestClient) -> None:
        response = await client.post('/payment_transactions', json={
            "source_address": "mfetsqmVYU1m3w1MNXaDg4cvGYwXJB47Kx",
            "outputs": {},
            "fee_kb": 25000,
    ...
    async def test_create_if_no_available_utxos(self, client: TestClient, mock_unspent_response: Any) -> None:
    ...
    async def test_create_if_no_available_confirmed_utxos(self, client: TestClient, mock_unspent_response: Any) -> None:
    ...
    async def test_create_transaction_if_invalid_source_address(self, client: TestClient) -> None:
        response = await client.post('/payment_transactions', json={
    ...
    async def test_create_transaction_if_invalid_output_address(self, client: TestClient) -> None:
        response = await client.post('/payment_transactions', json={
    ...
    async def test_create_transaction_if_insufficient_funds(self, client: TestClient,
    ...
    async def test_create_transaction_with_p2sh_input(self, client: TestClient) -> None:
        response = await client.post('/payment_transactions', json={
    ...
    async def test_create_transaction_if_both_p2sh_and_p2pkh_outputs(self, client: TestClient,
                                                                     mock_unspent_response: Any) -> None:
        await mock_unspent_response(web.json_response({
            "unspent_outputs": [{
                "tx_hash": "0bb4abea99101197cf2ddf43a2af1e73f868887d5f4a3619241cbb67413a34e7",
    ...
    async def test_create_transaction_if_no_change(self, client: TestClient, mock_unspent_response: Any) -> None:
        await mock_unspent_response(web.json_response({
            "unspent_outputs": [
                {
            ...
            'inputs': [
                {
                    ...
                    'vout': 0,
                    'script_pub_key': '76a9146efcf883b4b6f9997be9a0600f6c095fe2bd2d9288ac',
                    'amount': 12982733
                }
            ]
        }

    async def test_create_transaction_with_many_inputs(self, client: TestClient, mock_unspent_response: Any) -> None:
        await mock_unspent_response(web.json_response({
            "unspent_outputs": [
                {'tx_hash': '6287fd705063d962a2006c0b5f9fc65f0e6a5ba62783a2d9e3d9b27bad91ff97',
                 ...
                 'tx_index': 197378271, 'tx_output_n': 1,
                 'script': '76a9146efcf883b4b6f9997be9a0600f6c095fe2bd2d9288ac',
                 'value': 49989634, 'value_hex': '02fac802', 'confirmations': 163289},
                {'tx_hash': 'c1ad8c931707999f5e0cbfe504c3dc772907901d4001a517e567757fae2f7f2d',
                 ...
                 'tx_index': 197378103, 'tx_output_n': 0,
                 'script': '76a9146efcf883b4b6f9997be9a0600f6c095fe2bd2d9288ac',
                 'value': 1025703, 'value_hex': '0fa6a7', 'confirmations': 163290},
                {'tx_hash': '179a1cfd5e5a19747478461ea57f76b727a16f96254f79fba0dcd30e1029f551',
                 ...
                 'tx_index': 197343459, 'tx_output_n': 1,
                 'script': '76a9146efcf883b4b6f9997be9a0600f6c095fe2bd2d9288ac',
                 'value': 4382812, 'value_hex': '42e05c', 'confirmations': 163388},
                {'tx_hash': '276f505fe884ec4697a7a82f001012e235896a3b309ce13a3faf036a504f4209',
                 ...
                 'tx_index': 197343492, 'tx_output_n': 1,
                 'script': '76a9146efcf883b4b6f9997be9a0600f6c095fe2bd2d9288ac',
                 'value': 46447811, 'value_hex': '02c4bcc3', 'confirmations': 163388},
                {'tx_hash': 'c30fe13d1c77f5a31eff19a452b19dd970e9716897c78ea57b7f1e2d96e6fb0e',
                 ...
                 'tx_index': 197307258, 'tx_output_n': 0,
                 'script': '76a9146efcf883b4b6f9997be9a0600f6c095fe2bd2d9288ac',
                 'value': 930000, 'value_hex': '0e30d0', 'confirmations': 163535},
                {'tx_hash': 'fda33a301cfd9f0c324a96dfccaa4057127b274868a336fd313542a187d37e48',
                 ...
                 'tx_index': 197306217, 'tx_output_n': 0,
                 'script': '76a9146efcf883b4b6f9997be9a0600f6c095fe2bd2d9288ac',
                 'value': 930000, 'value_hex': '0e30d0', 'confirmations': 163544},
                {'tx_hash': 'af56d16f2e59315e1a49b73005d48e1faccefc323122797b0c0588187bc5a0a1',
                 ...
                 'tx_index': 197586654, 'tx_output_n': 0,
                 'script': '76a9146efcf883b4b6f9997be9a0600f6c095fe2bd2d9288ac',
                 'value': 894094, 'value_hex': '0da48e', 'confirmations': 162639},
                {'tx_hash': '14f2fcb8b5344c1c31edb2d3064b52d87255b548eae56692ccb89387b75280ce',
                 'tx_hash_big_endian': 'ce8052b78793b8cc9266e5ea48b55572d8524b06d3b2ed311c4c34b5b8fcf214',
                 'tx_index': 197306298, 'tx_output_n': 0,
                 'script': '76a9146efcf883b4b6f9997be9a0600f6c095fe2bd2d9288ac',
                 'value': 930000, 'value_hex': '0e30d0', 'confirmations': 163544},
                {'tx_hash': 'd0ecaa87d4629a59480d6b156e646a05010d244455fcb7d87af9ecc052fa0264',
                 'tx_hash_big_endian': '6402fa52c0ecf97ad8b7fc5544240d01056a646e156b0d48599a62d487aaecd0',
                 'tx_index': 197282253, 'tx_output_n': 0,
                 'script': '76a9146efcf883b4b6f9997be9a0600f6c095fe2bd2d9288ac',
                 'value': 12982733, 'value_hex': '00c619cd', 'confirmations': 163637},
                {'tx_hash': '13e1ce6d1803b46963871e89f768de93fdef7b86e820e1abd70c400dadeb1671',
                 ...
                 'tx_index': 197282181, 'tx_output_n': 1,
                 'script': '76a9146efcf883b4b6f9997be9a0600f6c095fe2bd2d9288ac',
                 'value': 45581249, 'value_hex': '02b783c1', 'confirmations': 163638}],
        }))
        ...
        response = await client.post('/payment_transactions', json={
            ...
            "outputs": {
                "mhnnkpnCfBkxN5KpfMArye2F376nATVJDW": "0.0001",
                "2MtDYVRt3Wdp2sDadhLnPoXDrzsTsBXq5c7": "0.5",
                "msrXsFAeRMLnY9mGPyeVwZZqxqVQUXh4uh": "0.02"
            },
            "fee_kb": 25000
        })
        ...
        response_data = await response.json()
        assert response_data == {
            'raw': '020000000213e1ce6d1803b46963871e89f768de93fdef7b86e820e1abd70c400dadeb16710100000000ffff'
                   'ffffd0ecaa87d4629a59480d6b156e646a05010d244455fcb7d87af9ecc052fa02640000000000ffffffff041'
                   '0270000000000001976a91418eef1d5d14e8032ca7caacefce7164179320b9388ac80f0fa020000000017a9140'
                   'aa6bd2de1acdfa92e4c932a4850a3883381402b8780841e00000000001976a91487556ff8cc729dd743ee7bf333'
                   '02098135b95c5e88ac86d66300000000001976a9146efcf883b4b6f9997be9a0600f6c095fe2bd2d9288ac00000000',
            'inputs': [
                {
                    'txid': '7116ebad0d400cd7abe120e8867beffd93de68f7891e876369b403186dcee113',
                    'vout': 1,
                    'script_pub_key': '76a9146efcf883b4b6f9997be9a0600f6c095fe2bd2d9288ac',
                    'amount': 45581249,
                },
    ...
    async def test_create_transaction_with_p2pkh_output(self, client: TestClient, mock_unspent_response: Any) -> None:
        await mock_unspent_response(web.json_response({
            "unspent_outputs": [{
                "tx_hash": "0bb4abea99101197cf2ddf43a2af1e73f868887d5f4a3619241cbb67413a34e7",
                "tx_hash_big_endian": "e7343a4167bb1c2419364a5f7d8868f8731eafa243df2dcf97111099eaabb40b",
